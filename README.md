...
* Agentipy - Interact with the Solana blockchain with actions
* Internet Search - Search the internet in real-time using Perplexity or OpenAI
* MCP - Interface with any MCP server via URL
...
### Solana
This plugin integrates the `agentipy` package, providing your Solana Agent with direct access to Solana blockchain actions.
