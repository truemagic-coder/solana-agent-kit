    ...
    def get_schema(self) -> Dict[str, Any]:
        return {
            ...
            "properties": {
                ...
                "in_amount": {
                    "type": "string",
                    "description": "Total amount of input token to DCA in base units (required for 'create').",
                },
                "order_count": {
                    "type": "integer",
                    "description": "Number of orders to split into (required for 'create').",
                },
                "frequency": {
                    "type": "string",
                    "description": "Interval between orders in seconds, e.g., '3600' for hourly, '86400' for daily (required for 'create').",
                },
                "min_out_amount": {
                    "type": "string",
                    "description": "Minimum output amount per order (optional for 'create').",
                },
                "max_out_amount": {
                    "type": "string",
                    "description": "Maximum output amount per order (optional for 'create').",
                },
                "start_at": {
                    "type": "string",
                    "description": "Unix timestamp when to start DCA (optional for 'create', defaults to now).",
                },
                "order_pubkey": {
                    "type": "string",
                ...
                "wallet_address": {
                    "type": "string",
                    "description": "Wallet address to query orders for (optional for 'list', defaults to configured wallet).",
                },
            },
            "required": ["action"],
